---
name: electronic
description: Prepare ABINIT electronic-analysis task inputs from prior converged context. Use when the user requests post-ground-state electronic analyses and needs prerequisite-aware setup.
compatibility: Requires prior converged ABINIT context, suitable pseudopotentials, and runnable ABINIT environment.
