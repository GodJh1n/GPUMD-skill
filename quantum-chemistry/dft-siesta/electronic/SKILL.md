---
name: electronic
description: Prepare SIESTA electronic-analysis task inputs from prior converged context. Use when the user requests post-ground-state electronic analyses and needs prerequisite-aware setup.
compatibility: Requires prior converged SIESTA context, compatible pseudopotentials, and runnable SIESTA environment.
...
# SIESTA Electronic Analysis (Subskill)
